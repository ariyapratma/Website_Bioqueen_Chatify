...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Chatify | PT Ratu Bio Indonesia'),
    ...
    */
    'routes' => [
        ...
        'assets' => env('VITE_ASSET_URL', 'http://localhost:5174/'),
    ],
    'api_routes' => [
    ...
    */
    'attachments' => [
        ...
        'allowed_files' => (array) ['zip', 'rar', 'txt', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'mp4', 'mp3'],
        'max_upload_size' => env('CHATIFY_MAX_FILE_SIZE', 10000000000), // MB
    ],
